...
# Mount
##create_dir /storage/
#TURNED OFF @ VirtualBox mount_storage
...
docker compose -f adguardhome.yaml up --detach
...
##touch ${CONTAINERDATA}/filebrowser/filebrowser.db
##touch ${CONTAINERDATA}/filebrowser/settings.json
