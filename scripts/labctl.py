...
def process_services(host_config_dir: Path, config: dict, pull_before_start: bool, state_override: str | None = None) -> None:
...
def cmd_config_apply(args) -> None:
    ...
    process_services(host_config_dir, config, args.pull_before_start, args.mode)
...
def cmd_service(args) -> None:
    ...
    docker_command(get_host_config_dir(), docker_stacks_dir / category_path, service_name, args.pull_before_start, args.operation)
